  		...
  		<div class="clearfix">
            <div class="content_l">
            	<div class="fl" id="resume_name">
	            	<div class="nameShow fl">
	            		...
	            		<span class="rename">重命名</span> | <a target="_blank" href="<?php echo Url::to(['jobs/preview'])?>">预览</a>
            		</div>
            		<form class="fl dn" id="resumeNameForm">
            			<input type="text" value="jason的简历" name="resumeName" class="nameEdit c9">	
            			<input type="submit" value="保存"> | <a target="_blank" href="<?php echo Url::to(['jobs/preview'])?>">预览</a>
            		</form>
            	</div><!--end #resume_name-->
            ...
            <div class="content_r">
            	<div class="mycenterR" id="myInfo">
            		<h2>我的信息</h2>
            		<a target="_blank" href="<?php echo Url::to(['collect/positions'])?>">我收藏的职位</a>
            		<br>
            		            		            		<a target="_blank" href="<?php echo Url::to(['subscribe/subscribesel'])?>">我订阅的职位</a>
            	</div><!--end #myInfo-->
