    	...
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
            	...
            	<dt>
                	...
                	<dd class="btm" style="display: none;"><a href="<?php echo Url::to(['company/index'])?>">我的公司主页</a></dd>
...
<dl class="company_center_aside">
	...
	<dd>
		<a href="<?php echo Url::to(['jobs/dowline'])?>">已下线职位</a>
	</dd>
	</dl>
            </div><!-- end .sidebar -->
            <div class="content">
            	<dl class="company_center_content">
                    ...
                    <dd>
                    	<form action="autoFilterResumes.html" method="get" id="filterForm">
		                        	...
		                        	面试通知系统,状态分为 <span>已通知</span>和<span>未通知</span>若<span>3</span>日内未作处理，本网站将自动发送通知邮件至用户邮箱。
		                        </div>
...
<table class="list_table" width="100%" cellpadding="0" cellspacing="0" >
	...
	<tr>
			<td><label class="checkbox"><input type="checkbox"><i></i></label></td>
			<td></td>
			<td></td>
			<td></td>
			<td></td>
