    	...
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
            	...
            	<dt>
                	...
                	<dd style="display: none;"><a href="<?php echo Url::to(['jobs/online'])?>">我发布的职位</a></dd>
                	<dd style="display: none;"><a href="<?php echo Url::to(['jobs/undetermined'])?>">我收到的简历</a></dd>
                	<dd class="btm" style="display: none;"><a href="<?php echo Url::to(['company/home'])?>">我的公司主页</a></dd>
                    <dd style="display: none;"><a href="<?php echo Url::to(['account/accountbind'])?>">帐号设置</a></dd>
                	<dd class="logout" style="display: none;"><a rel="nofollow" href="<?php echo Url::to(['login/logout'])?>">退出</a></dd>
            </dl>
        </div>
    </div><!-- end #header -->
    <div id="container">
        	...
        	<div class="sidebar">
            	<a class="btn_create" href="<?php echo Url::to(['jobs/cre'])?>">发布新职位</a>
                <dl class="company_center_aside">
		<dt>我收到的简历</dt>
		
	<dd>
		<a href="<?php echo Url::to(['jobs/undetermined'])?>">待定简历</a>
	</dd>
	<dd>
		<a href="<?php echo Url::to(['jobs/notice'])?>">面试通知</a>
	</dd>
	<dd>
		<a href="<?php echo Url::to(['jobs/refuse'])?>">不合适简历</a>
	</dd>
	<dd class="btm">
		<a href="<?php echo Url::to(['jobs/autofilter'])?>">自动过滤简历</a> 
			</dd>
</dl>
<dl class="company_center_aside">
		<dt>我发布的职位</dt>
			<dd>
		<a href="<?php echo Url::to(['jobs/online'])?>">有效职位</a>
	</dd>
	<dd>
		<a href="<?php echo Url::to(['jobs/downline'])?>">已下线职位</a>
	</dd>
	</dl>
            ...
            <div class="content">
            	<dl class="company_center_content">
                    ...
                    <dd>
                    	...
                    	<?php $form = ActiveForm::begin(['action' =>['jobs/preview'] ]); ?>
