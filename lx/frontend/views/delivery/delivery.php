	...
	<div id="header">
    	<div class="wrapper">
            ...
            <dl class="collapsible_menu">
            	...
            	<span class="bot"></span>
				<span class="top"></span>
				<a target="_blank" href="<?php echo Url::to(['delivery/delivery'])?>"><strong>0</strong>条新投递反馈</a>
        ...
        <div class="clearfix">
            ...
            <div class="content_r">
            	<div class="mycenterR" id="myInfo">
            		<h2>我的信息</h2>
            		<a href="<?php echo Url::to(['collect/positions'])?>">我收藏的职位</a>
            		<br>
            		            		<a href="<?php echo Url::to(['work/deliver'])?>" target="_blank">我投递的职位<span id="noticeNoPage" class="red dn">&nbsp;(0)</span></a>
            		<br>
            		            		<a target="_blank" href="<?php echo Url::to(['subscrib/subscribesel'])?>">我订阅的职位</a>
            		            		<br>
            		<a target="_blank" href="<?php echo Url::to(['recommend/recommendlist'])?>">我的职位推荐</a>
            		            	</div><!--end #myInfo-->
            		...
            		<ul class="reset">
            				...
            				<a target="_blank" href="http://www.lagou.com/jobs/147510.html">
								...
								<em>88%</em>
            		            		...
            		            		<a target="_blank" class="more" href="<?php echo Url::to(['recommend/recommendlist'])?>">更多推荐职位&gt;&gt;</a>
            		            	</div><!--end #myRecommend-->
