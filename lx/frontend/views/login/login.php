    	...
    	<input type="hidden" id="resubmitToken" value="" />		
		 <div class="login_box">
			...
			<div class="login_right">
				<div>还没有拉勾帐号？</div>
				<a  href="<?php echo Url::to(['reg/reg'])?>"  class="registor_now">立即注册</a>
