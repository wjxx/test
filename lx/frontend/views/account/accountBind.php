...
<title>绑定帐号-帐号设置-拉勾网-最专业的互联网招聘平台</title>
...
<div id="body">
    ...
    <dl id="user_sideBarmenu" class="user_sideBarmenu">
     	        <dt><h3>帐号设置</h3></dt>
                <dd><a class="hover" href="<?php echo Url::to(['account/accountbind'])?>">帐号绑定</a></dd>
        <dd><a href="<?php echo Url::to(['account/updatepwd'])?>">修改密码</a></dd>
            </dl>
</div>
...
<div style="display:none;">
   ...
   <div class="popup user_popup" id="confirmUnbind">
	...
	<div style="overflow:hidden" class="popup" id="unbindService">
		...
		<a class="btn" href="<?php echo Url::to(['account/bindstep1'])?>">立即跳转</a>
	</div>
